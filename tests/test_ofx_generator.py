...
class TestOFXGenerator(unittest.TestCase):
    ...
    def test_deterministic_fitid_with_value_inversion(self):
        ...
        self.assertEqual(
            ...
            "Value inversion should produce consistent IDs for equivalent transactions"
        )
    ...
    def test_deterministic_fitid_with_long_description(self):
        ...
        self.assertEqual(
            transaction_id, transaction_id_255,
            "Long description should be truncated to 255 characters for transaction ID"
        )
        ...
        self.assertNotEqual(
            transaction_id, transaction_id_diff,
            "Different character within 255 limit should produce different transaction ID"
        )
